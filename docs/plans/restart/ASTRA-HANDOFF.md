...
Update plan/progress and publish each meaningful accepted work unit. Do not mark
the goal complete before implementation, all three trials and the audit are done;
report exact blockers and preserve partial progress if an external capability fails.
