# Historical guided trial prompts

Status: superseded on 2026-09-16 by the one-link setup flow. Preserve as evidence of the earlier guided handoff; do not use for the next trial. Use these prompts only after the full
